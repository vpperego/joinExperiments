...
object TpcHQ3Throughput {
  ...
  var customerStorage = new ThroughputGenericStorage[Customer](sc,"customer")
  var orderStorage = new ThroughputGenericStorage[Order](sc,"order")
  var lineItemStorage = new ThroughputGenericStorage[LineItem](sc,"lineItem")
  var intermediateStorage = new ThroughputGenericStorage[((Customer, Order), Long, Long)](sc,"Intermediate Storage")
  ...
  println("Waiting for jobs (TPC-H Q3) Throughput")
